...
class Item extends React.Component {
    ...
    componentDidMount = async() => {
        ...
        .then(async(response) =>{
            ...
            await this.setState({title:response['data'][0]['title'],description:response['data'][0]['description'],image:response['data'][0]['image'],price:response['data'][0]['price'],quantity:response['data'][0]['quantity'],id:response['data'][0]['id']})
            })
    }
    ...
    SubmitForm = async(e) => {
        ...
        if(await this.validation()){
          ...
          const url = 'http://localhost:3500/Item/'+this.state.id;
          ...
          .then(res => {
              ...
              if(res.data.err){
                ...
                this.props.history.push("/item_all")
              }
          })
        }
    }
